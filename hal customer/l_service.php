<?php
 ...
 if (isset($_POST['buttom'])) {
    $id_customer= $_POST['id_customer_service'];
    $nama = $_POST['nama'];
    $alamat = $_POST['alamat'];
    $no_tlp = $_POST['no_tlp'];
    ...
    $sql="INSERT INTO tservice_customer VALUES ('','$nama','$alamat','$no_tlp','$jbarang','$keluhan','$status','$tingkat_kesulitan','$tgl_service')";
...
<head>
    ...
    <link rel="stylesheet" href="l_service.css">
    <style>
        body {
...
<body>
    ...
    <center>
    <h1>LIST SERVICE</h1>
    <h3>jika ingin service isi data pemesanan dibawah</h3>
    </center>
  ...
  <tr>
    <td>komputer tidak menyala</td>
    <td>layar membeku</td>
    <td>mati total</td>
  </tr>
  <tr>
    <td>windows tidak mau jalan</td>
    <td>virus</td>
    <td>lcd rusak parah</td>
  </tr>
  <tr>
    <td>engsel layar</td>
    <td>chipset rusak</td>
    <td>motherboard rusak</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>mudah 250.000</td>
    <td>sedang 500.000</td>
    <td>sulit 1.000.000</td>
  </tr>
</table>
    ...
    <div class="conta">
        <form action="" method="POST">
            ...
            <div class="input-box-special">
                <input class="input" type="text" name="keluhan" required>
                <label class="label" for="keluhan">Keluhan</label>
            </div>
