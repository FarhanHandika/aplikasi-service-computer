<?php
 ...
 if (isset($_POST['buttom'])) {
    ...
    $sql="INSERT INTO transaksi_upgrade VALUES ('','$nama','$nama_barang_harga','$bayar','$tanggal_transaksi','$sts')";
    $result =mysqli_query($koneksi,$sql);
    header("location:pembayaran_upgrade.php");
...
<head>
    ...
    <title>keluhan</title>
    <link rel="stylesheet" href="pembayaran_upgrade.css">
