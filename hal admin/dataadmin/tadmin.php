...
<div class="center-button">
    <a href="tadmin-add.php" class="btn btn-primary">Tambah Data</a>
</div>
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        if (isset($_GET['c'])) {
            $no = 1;
            $c =$_GET['p'];       
              $query =mysqli_query($koneksi,"SELECT * FROM admin WHERE username LIKE'%$c%'");
              foreach ($query as $tampil) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="hapus.php?login_id=<?= $tampil['login_id']?>">Hapus</a>
                    </td>
                </tr>
                <?php
                }
