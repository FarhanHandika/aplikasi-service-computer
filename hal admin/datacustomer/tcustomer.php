...
<div class="center-button">
    <a href="tcustomer-add.php" class="btn btn-primary">Tambah Data</a>
</div>
...
<table class="table table-bordered table-hover">
    ...
    <?php 
        ...
        if (isset($_GET['c'])) {
            $no = 1;
            $c =$_GET['p'];       
              $query =mysqli_query($koneksi,"SELECT * FROM l_customer WHERE username LIKE'%$c%'");
              foreach ($query as $tampil) {
                ...
                <tr>
                    ...
                    <td>
                        <a href="hapus-customer.php?login_id=<?= $tampil['login_id']?>">Hapus</a>
                    </td>
                </tr>
                <?php
                }
