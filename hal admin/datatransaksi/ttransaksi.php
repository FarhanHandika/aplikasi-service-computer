...
<div class="center-button">
    <a href="transaksi-add.php" class="btn btn-primary">Tambah Data</a>
</div>
...
<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td><?= $tampil['sts']; ?></td>
        <td>
            <a href="transaksi-edit.php?id_transaksi=<?= $tampil['id_transaksi']?>">Edit</a> |
            <a href="hapus-transaksi.php?id_transaksi=<?= $tampil['id_transaksi']?>">Hapus</a>
        </td>
    </tr>
    <?php
    $no++;
