...
<div class="center-button">
    <a href="data-upgrade-add.php" class="btn btn-primary">Tambah Data</a>
</div>
...
<table class="table table-bordered table-hover">
    <thead class="thead-light">
       <tr>
          ...
          <th scope="col">Tanggal Upgrade</th>
    ...
    $no = 1;
    $query = "SELECT * FROM tupgrade_customer";
    ...
    <tr>
        ...
        <td><?= $tampil['sts']; ?></td>
        <td><?= $tampil['jbarang_harga']; ?></td>
        <td><?= $tampil['tgl_upgrade']; ?></td>
        <td><?= $tampil['stok']; ?></td>
        <td>
            <a href="data-upgrade-edit.php?id_customer=<?= $tampil['id_customer']?>">Edit</a> |
            <a href="hapus-data-upgrade.php?id_customer=<?= $tampil['id_customer']?>">Hapus</a>
        </td>
    </tr>
    <?php
    $no++;
